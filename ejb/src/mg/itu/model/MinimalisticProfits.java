...
public class MinimalisticProfits extends BaseModel<MinimalisticProfits> {
    ...
    private double minimalisticProfit;
    ...
    public double getMinimalisticProfit() {
        return minimalisticProfit;
    }

    public void setMinimalisticProfit(double minimalisticProfit) {
        this.minimalisticProfit = minimalisticProfit;
    }
    ...
    // Mapping ResultSet to MinimalisticProfits object
    @Override
    protected MinimalisticProfits mapRow(ResultSet result) throws Exception {
        MinimalisticProfits profits = new MinimalisticProfits();
        ...
        profits.setMinimalisticProfit(result.getDouble("minimalistic_profit"));
    ...
    protected Map<String, Object> getFieldsMap() {
        ...
        fields.put("minimalistic_profit", minimalisticProfit);
